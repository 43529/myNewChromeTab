...
function addNewLink() {
  ...
  const newLink = `
    <li class="link-item"><a href="` + linkUrl + `">` + linkName + `</a></li>
  `;
  return newLink;
}
// 执行
...
document.getElementById('popup-content-button-cancle')
    .addEventListener('click', hideModal);
document.getElementById('popup-content-button-confirm')
